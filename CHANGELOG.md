...
- `00_StockNames.cfg`: rename of bodies and of every JNSQ-Reborn config keyed on them (`:FINAL`).
- `01_DedupeLeftovers.cfg`: removal of the classic-JNSQ / stock EVE / Firefly configs that would otherwise load twice (`:LAST[JNSQ-Reborn]`).
